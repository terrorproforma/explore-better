...
<html lang="en">
  ...
  <body>
    ...
    <header class="site-header detail-header">
      <a class="brand" href="${prefix}" aria-label="Explore Better home"><img src="${prefix}assets/app-icon.png" alt="" width="34" height="34" /><span>Explore Better</span></a>
    ...
    <footer class="site-footer"><div class="page-shell footer-layout"><a class="brand brand--footer" href="${prefix}"><img src="${prefix}assets/app-icon.png" alt="" width="32" height="32" /><span>Explore Better</span></a><p>The Windows file manager built for humans and AI.</p><div class="footer-links"><a href="${prefix}security/">Security</a><a href="${prefix}privacy/">Privacy</a><a href="${prefix}terms/">Terms</a><a href="https://github.com/terrorproforma/explore-better">Source</a></div><small>MIT licensed</small></div></footer>
  </body>
</html>`;
}
